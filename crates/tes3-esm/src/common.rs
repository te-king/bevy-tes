...
/// A typed enum for an integer discriminant field, as generated by the crate's
/// `enum_field!` macro: names its storage width and converts from raw bits infallibly
/// (unmodeled values land in the enum's `Unknown` variant).
